...
import com.six15.common.BaseService;
import com.six15.usb.USBMonitor;
import com.six15.usbcameratest4.MainActivity;
import com.six15.usbcameratest4.R;

public class HudService extends BaseService {
	...
	private String createChannel() {
		...
		String CHANNEL_ID = "SIX15_CHANNEL";

		// Create the NotificationChannel, but only on API 26+ because
		// the NotificationChannel class is new and not in the support library
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			CharSequence name = "usbcamtest4_channel";
			String description = "usbcamtest4";
	...
	private void showNotification(final CharSequence text) {
		...
		String serviceChannel = createChannel();
			...
			queueEvent(new Runnable() {
				...
				public void run() {
					...
					synchronized (sServiceSync) {
						...
						if (service == null) {
							service = CameraServer.createServer(HudService.this, ctrlBlock, device.getVendorId(), device.getProductId());
